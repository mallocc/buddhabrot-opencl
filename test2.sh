...
args+=" -steps 90 -nc -alpha 90 -beta 90"
...
./x64/Release/buddhabrot-opencl.exe -gamma 2.5 -w 256 -h 256 -s 10000000 -i 1000 -im 0 -x0 -2 -y0 -1.5 -x1 1 -y1 1.5 -o output/test ${args[*]}
