...
args+=" -nc -x0 0.357199074074074074261 -y0 0.682199074074074074018 -x1 0.362222222222222222408 -y1 0.687222222222222222165"
...
./x64/Release/buddhabrot-opencl.exe -bezier-enable -gen-in-region -gamma 2.5 -w 256 -h 256 -s 10000000 -ir 1024 -ig 256 -ib 128 -im 64 -x0 -2 -y0 -1.5 -x1 1 -y1 1.5 -o output/test ${args[*]}
